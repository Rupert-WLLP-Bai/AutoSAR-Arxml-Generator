...
#  * @Last Modified time: 2023-11-28 17:13:20
#  */
...
def main(timing=False):
    ...
    step3_time = execute_command("python idt_excel2arxml.py", "Excel2Arxml")
    step4_time = execute_command("python component_gen.py", "Excel2Arxml")
