...
display_format_str_re = re.compile(r"%[ \-+#]?[0-9]*(\.[0-9]+)?[diouxXfeEgGcs]")
...
class ARObject:
    ...
    def _assign_int_or_str_pattern_optional(
        self, attr_name: str, value: int | str | None, pattern: re.Pattern
    ) -> None:
        """
    ...
    def _assign_int_or_str_pattern(
        self, attr_name: str, value: int | str, pattern: re.Pattern
    ) -> None:
        """
        ...
        if isinstance(value, int):
            ...
            raise TypeError(
                f"{attr_name}: Invalid type. Expected (int, str), got '{str(type(value))}'"
            )
        setattr(self, attr_name, value)

    def _assign_optional_strict(
        self, attr_name: str, value: Any, type_name: type
    ) -> None:
        """
    ...
    def _set_attr_with_strict_type(
        self, attr_name: str, value: Any, type_class: type
    ) -> None:
        """
    ...
    def _set_attr_from_str_or_direct(self, attr_name: str, value: Any, type_name: type):
        ...
        if isinstance(value, str):
            ...
            raise TypeError(
                f"Invalid type  for '{attr_name}'"
                f". Expected one of (str, {type_name}), got '{str(type(value))}'"
            )
        setattr(self, attr_name, new_value)

    def _set_attr_with_type_cast(
        self, attr_name: str, value: Any, type_class: type
    ) -> None:
        """
    ...
    def _set_attr_positive_int(self, attr_name: str, value: int) -> None:
        ...
        if not isinstance(value, int):
            raise TypeError(
                f"Invalid type for '{attr_name}'. Expected int, got '{str(type(value))}'"
            )
        if value < 0:
...
class MultiLanguageReferrable(Referrable):
    ...
    def __init__(
        self, name: str, long_name: Union["MultilanguageLongName", None] = None
    ) -> None:
        super().__init__(name)
        ...
        **kwargs,
        ...
        if desc is not None:
            if isinstance(desc, MultiLanguageOverviewParagraph):
                ...
                self.desc = MultiLanguageOverviewParagraph.make(
                    ar_enum.Language.FOR_ALL, desc
                )
...
class BaseRef(ARObject, abc.ABC):
    ...
    def __init__(self, value: str, dest: ar_enum.IdentifiableSubTypes) -> None:
        self.value = value
        ...
        if dest in self._accepted_subtypes():
            ...
            raise ValueError(
                f"{str(dest)} is not a valid sub-type for {str(type(self))}"
            )
...
class IndexDataTypeRef(BaseRef):
    ...
    def __init__(self, value: str) -> None:
        super().__init__(
            value, ar_enum.IdentifiableSubTypes.APPLICATION_PRIMITIVE_DATA_TYPE
        )
...
class AutosarDataTypeRef(BaseRef):
    ...
    def _accepted_subtypes(self) -> set[ar_enum.IdentifiableSubTypes]:
        """Acceptable values for dest"""
        return {
            ar_enum.IdentifiableSubTypes.ABSTRACT_IMPLEMENTATION_DATA_TYPE,
            ar_enum.IdentifiableSubTypes.APPLICATION_ARRAY_DATA_TYPE,
            ar_enum.IdentifiableSubTypes.APPLICATION_ASSOC_MAP_DATA_TYPE,
            ar_enum.IdentifiableSubTypes.APPLICATION_COMPOSITE_DATA_TYPE,
            ar_enum.IdentifiableSubTypes.APPLICATION_DATA_TYPE,
...
class EmphasisText(ARObject):
    ...
    def __init__(
        ...
        type: ar_enum.EmphasisType = None,
...
class TechnicalTerm(ARObject):
    ...
    def __init__(
        self, text: str, tex_render: str = None, type: str = None
    ) -> None:  # pylint: disable=redefined-builtin
...
class MixedContentForLongName(LanguageSpecific):
    ...
    def append(self, part: str | TechnicalTerm | EmphasisText | Subscript | Subscript):
        ...
        """
        if isinstance(
            part, (str, TechnicalTerm, EmphasisText, Subscript, Subscript, IndexEntry)
        ):
...
class LanguageLongName(MixedContentForLongName):
    ...
    * Subscript
    ...
    def __init__(
        self, language: ar_enum.Language, parts: None | str | list[Any] = None
    ) -> None:
        super().__init__(language)
...
class MultilanguageLongName(ARObject):
    ...
    def __init__(
        self, long_name: None | tuple[ar_enum.Language, str] | LanguageLongName = None
    ) -> None:
...
class MultiLanguageOverviewParagraph(ARObject):
    ...
    def __init__(
        self,
        paragraph: None
        | tuple[ar_enum.Language, str]
        | LanguageOverviewParagraph = None,
    ) -> None:
...
class DocumentViewSelectable(ARObject):
    ...
    def __init__(
        self, semantic_information: None | str = None, view: None | str = None
    ) -> None:
        self.semantic_information = semantic_information  # Attribute 'SI'
        self.view = view  # Attribute 'VIEW'
        if semantic_information is not None and (
            not isinstance(semantic_information, str)
        ):
            raise TypeError(
        ...
        if view is not None and (not isinstance(view, str)):
            raise TypeError(f"view: Expected type 'str', got '{str(type(view))}'")
...
class Paginateable(DocumentViewSelectable):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if (keep_with_previous is not None) and (
            not isinstance(keep_with_previous, ar_enum.KeepWithPrevious)
        ):
            raise TypeError(
...
class MixedContentForParagraph(LanguageSpecific):
    ...
    def append(
        ...
        if isinstance(
            part,
            (str, Break, EmphasisText, IndexEntry, Subscript, Subscript, TechnicalTerm),
        ):
            self.parts.append(part)
        else:
            raise TypeError("Unsupported element type: " + str(type(part)))
...
class MultiLanguageParagraph(Paginateable):
    ...
    def __init__(
        self,
        paragraph: None | tuple[ar_enum.Language, str] | LanguageParagraph = None,
...
class MixedContentForVerbatim(LanguageSpecific):
    ...
    def append(self, part: str | Break | EmphasisText | TechnicalTerm):
        """
        Checks type validity before adding element to elements
        """
...
class MultiLanguageVerbatim(Paginateable):
    ...
    def __init__(
        self,
        element: None | tuple[ar_enum.Language, str] | LanguageVerbatim = None,
...
class DocumentationBlock(ARObject):
    ...
    def __init__(
        self,
        element: MultiLanguageParagraph
    ...
    def append(self, element: MultiLanguageParagraph | MultiLanguageVerbatim) -> None:
        ...
        """
        assert isinstance(element, (MultiLanguageParagraph, MultiLanguageVerbatim))
...
class GeneralAnnotation(ARObject):
    ...
    def __init__(
        ...
        text: DocumentationBlock | None = None,
    ) -> None:
        super().__init__()
...
class CompuRational(ARObject):
    ...
    def __init__(
        ...
        denominator: tuple[int | float] | list[int | float] | None = None,
    ) -> None:
        if numerator is not None:
            if not isinstance(numerator, (tuple, list)):
                raise TypeError(
                    "Parameter for 'numerator' must be either a list or a tuple"
                )
        ...
        if denominator is not None:
            if not isinstance(denominator, (tuple, list)):
                raise TypeError(
                    "Parameter for 'denominator' must be either a list or a tuple"
                )
    ...
    def __init__(
        ...
        if inverse_value is not None:
            if isinstance(inverse_value, CompuConst):
                ...
                raise TypeError(
                    f"Invalid type for 'inverse_value': {str(type(inverse_value))}"
                )
...
class Computation(ARObject):
    ...
    def __init__(
        ...
        self.default_value: CompuConst | int | float | str | None = (
            None  # .COMPU-DEFAULT-VALUE
        )
    ...
    def make_value_table(
        ...
        for i, elem in enumerate(elements):
            ...
            if auto_label and isinstance(value, str):
                label = value
            compu_scales.append(
                CompuScale(CompuConst(value), lower_limit, upper_limit, label)
            )
    ...
    def make_rational(
        ...
        compu_scales = [
            CompuScale(
                CompuRational(numerator, denominator),
                lower_limit,
                upper_limit,
...
class DataConstraint(ARElement):
    ...
    def __init__(
        self, name: str, rules: list[DataConstraintRule] | None = None, **kwargs: dict
    ) -> None:
        super().__init__(name, **kwargs)
        self.rules = []
...
class Unit(ARElement):
    ...
    def __init__(
        ...
        **kwargs: dict,
        ...
        self.physical_dimension_ref: PhysicalDimensionRef | None = (
            None  # .PHYSICAL-DIMENSION-REF
        )
        ...
        if display_name is not None:
            if isinstance(display_name, str):
                ...
                raise TypeError(
                    f"display_name: Invalid type '{str(type(display_name))}'"
                )
        if physical_dimension_ref is not None:
            if isinstance(physical_dimension_ref, str):
                ...
                raise TypeError(
                    f"physical_dimension_ref: Invalid type '{str(type(physical_dimension_ref))}'"
                )
...
class SwBitRepresentation(ARObject):
    ...
    def __init__(
        self, position: int | None = None, num_bits: int | None = None
    ) -> None:
        super().__init__()
...
class SwTextProps(ARObject):
    ...
    def __init__(
        ...
        self.array_size_semantics: ar_enum.ArraySizeSemantics | None = (
            None  # .ARRAY-SIZE-SEMANTICS
        )
        ...
        self._assign_optional(
            "array_size_semantics", array_size_semantics, ar_enum.ArraySizeSemantics
        )
...
class SwPointerTargetProps(ARObject):
    ...
    def __init__(
        ...
        sw_data_def_props: Union[
            "SwDataDefProps", "SwDataDefPropsConditional", None
        ] = None,
        function_ptr_signature_ref: FunctionPtrSignatureRef | None = None,
    ) -> None:
        self.target_category: str | None = None  # .TARGET-CATEGORY
        self.sw_data_def_props: Union[
            "SwDataDefProps", None
        ] = None  # .SW-DATA-DEF-PROPS
        self.function_ptr_signature_ref: FunctionPtrSignatureRef | None = (
            None  # .FUNCTION-POINTER-SIGNATURE-REF
        )
        self._assign_optional("target_category", target_category, str)
        self._assign_optional(
            "function_ptr_signature_ref",
            function_ptr_signature_ref,
        ...
        if sw_data_def_props is not None:
            if isinstance(sw_data_def_props, SwDataDefProps):
                ...
                raise TypeError(
                    "'sw_data_def_props' must be one of (SwDataDefProps, SwDataDefPropsConditional)"
                )
...
class SwDataDefPropsConditional(ARObject):
    ...
    def __init__(
        ...
        self.bit_representation: SwBitRepresentation | None = (
            None  # .SW-BIT-REPRESENTATION
        )
        self.calibration_access: ar_enum.SwCalibrationAccess | None = (
            None  # .SW-CALIBRATION-ACCESS
        )
        ...
        self.impl_data_type_ref: ImplementationDataTypeRef | None = (
            None  # .IMPLEMENTATION-DATA-TYPE-REF
        )
        # .SW-HOST-VARIABLE not yet supported. Low on priority list.
        self.impl_policy: ar_enum.SwImplPolicy | None = None  # .SW-IMPL-POLICY
        self.additional_native_type_qualifier: str | None = (
            None  # .ADDITIONAL-NATIVE-TYPE-QUALIFIER
        )
        ...
        self.ptr_target_props: SwPointerTargetProps | None = (
            None  # .SW-POINTER-TARGET-PROPS
        )
        ...
        self._assign_optional(
            "display_presentation", display_presentation, ar_enum.DisplayPresentation
        )
        ...
        self._assign_int_or_str_pattern_optional(
            "alignment", alignment, alignment_type_re
        )
        self._assign_optional("base_type_ref", base_type_ref, SwBaseTypeRef)
        if bit_representation is not None:
            if not isinstance(bit_representation, SwBitRepresentation):
                raise TypeError(
                    f"bit_representation: Invalid type '{str(type(bit_representation))}'."
                    " Expected 'SwBitRepresentation'"
                )
            self.bit_representation = bit_representation
        self._assign_optional(
            "calibration_access", calibration_access, ar_enum.SwCalibrationAccess
        )
        if text_props is not None:
            if not isinstance(text_props, SwTextProps):
                raise TypeError(
                    f"text_props: Invalid type '{str(type(text_props))}'."
                    " Expected 'SwTextProps'"
                )
            self.text_props = text_props
        self._assign_optional("compu_method_ref", compu_method_ref, CompuMethodRef)
        self._assign_optional(
            "data_constraint_ref", data_constraint_ref, DataConstraintRef
        )
        self._assign_optional(
            "impl_data_type_ref", impl_data_type_ref, ImplementationDataTypeRef
        )
        self._assign_optional("unit_ref", unit_ref, UnitRef)
        self._assign_int_or_str_pattern_optional(
            "display_format", display_format, display_format_str_re
        )
        self._assign_optional("impl_policy", impl_policy, ar_enum.SwImplPolicy)
        self._assign_optional(
            "additional_native_type_qualifier", additional_native_type_qualifier, str
        )
        if intended_resolution is not None:
            if isinstance(intended_resolution, (int, float)):
                ...
                raise TypeError(
                    f"Invalid type '{str(type(intended_resolution))}' for paramater 'intended_resolution'"
                )
        ...
        if ptr_target_props is not None:
            self._set_attr_with_strict_type(
                "ptr_target_props", ptr_target_props, SwPointerTargetProps
            )
...
class SwDataDefProps(ARObject):
    ...
    def __init__(
        self,
        variants: SwDataDefPropsConditional
        | list[SwDataDefPropsConditional]
        | None = None,
    ) -> None:
        super().__init__()
        self.variants: list[
        ...
        if variants is not None:
            if isinstance(variants, list):
                ...
                raise TypeError(
                    "variant must be one of (SwDataDefPropsConditional, list[SwDataDefPropsConditional])"
                )
...
class ImplementationProps(Referrable):
    ...
    def __init__(self, name: str, symbol: str | None = None) -> None:
        super().__init__(name)
...
class ImplementationDataTypeElement(Identifiable):
    ...
    def __init__(
        ...
        **kwargs: dict,
        ...
        self.array_impl_policy: ar_enum.ArrayImplPolicy | None = (
            None  # .ARRAY-IMPL-POLICY
        )
        self.array_size_handling: ar_enum.ArraySizeHandling | None = (
            None  # .ARRAY-SIZE-HANDLING
        )
        self.array_size_semantics: ar_enum.ArraySizeSemantics | None = (
            None  # .ARRAY-SIZE-SEMANTICS
        )
        ...
        self._assign_optional(
            "array_impl_policy", array_impl_policy, ar_enum.ArrayImplPolicy
        )
        self._assign_optional(
            "array_size_handling", array_size_handling, ar_enum.ArraySizeHandling
        )
        self._assign_optional(
            "array_size_semantics", array_size_semantics, ar_enum.ArraySizeSemantics
        )
...
class ImplementationDataType(AutosarDataType):
    ...
    def __init__(
        ...
        **kwargs: dict,
        ...
        super().__init__(name, **kwargs)
        self.dynamic_array_size_profile: str | None = (
            None  # .DYNAMIC-ARRAY-SIZE-PROFILE
        )
        self.is_struct_with_optional_element: bool | None = (
            None  # .IS-STRUCT-WITH-OPTIONAL-ELEMENT
        )
        ...
        self._assign_optional(
            "dynamic_array_size_profile", dynamic_array_size_profile, str
        )
        self._assign_optional(
            "is_struct_with_optional_element", is_struct_with_optional_element, bool
        )
...
class AutosarDataPrototype(DataPrototype):
    ...
    def __init__(
        self, name: str, type_ref: AutosarDataTypeRef | None = None, **kwargs: dict
    ) -> None:
        super().__init__(name, **kwargs)
...
class ApplicationCompositeElementDataPrototype(DataPrototype):
    ...
    def __init__(
        self, name: str, type_ref: ApplicationDataTypeRef | None = None, **kwargs: dict
    ) -> None:
        super().__init__(name, **kwargs)
...
class ApplicationArrayElement(ApplicationCompositeElementDataPrototype):
    ...
    def __init__(
        ...
        **kwargs: dict,
        ...
        self._assign_optional_positive_int(
            "max_number_of_elements", max_number_of_elements
        )
        self._assign_optional(
            "index_data_type_ref", index_data_type_ref, IndexDataTypeRef
        )
...
class ApplicationArrayDataType(ApplicationCompositeDataType):
    ...
    def ref(self) -> ApplicationDataTypeRef | None:
        ...
        value = "/".join(reversed(ref_parts))
        return ApplicationDataTypeRef(
            value, ar_enum.IdentifiableSubTypes.APPLICATION_ARRAY_DATA_TYPE
        )
...
class ApplicationRecordElement(ApplicationCompositeElementDataPrototype):
    ...
    def __init__(
        self, name: str, is_optional: bool | None = None, **kwargs: dict
    ) -> None:
        super().__init__(name, **kwargs)
        self.is_optional: bool | None = None  # .IS-OPTIONAL
        self._assign_optional("is_optional", is_optional, bool)
...
class ApplicationRecordDataType(ApplicationCompositeDataType):
    ...
    def __init__(
        self,
        name: str,
        elements: ApplicationRecordElement
        | list[ApplicationRecordElement]
        | None = None,
        **kwargs,
    ) -> None:
        super().__init__(name, **kwargs)
    ...
    def extend(self, elements: list[ApplicationRecordElement]) -> None:
        ...
        for (
            ...
            elements
        ):  # We want to type-check each element before adding to internal list
            self.append(element)
    ...
    def ref(self) -> ApplicationDataTypeRef | None:
        ...
        value = "/".join(reversed(ref_parts))
        return ApplicationDataTypeRef(
            value, ar_enum.IdentifiableSubTypes.APPLICATION_RECORD_DATA_TYPE
        )
        ...
        **kwargs: dict,
        ...
        if data_type_maps is not None:
            if isinstance(data_type_maps, DataTypeMap):
                ...
                raise TypeError(
                    f'data_type_maps: Invalid type "{str(type(data_type_maps))}"'
                )
...
class ValueList(ARObject):
    ...
    def __init__(
        self, values: list[int | float | NumericalValue] | None = None
    ) -> None:
        self.values = []
...
class SwAddrMethod(ARElement):
    ...
    def __init__(self, name: str, **kwargs) -> None:
        super().__init__(name, **kwargs)
        self.memory_allocation_keyword_policy = (
            None  # .MEMORY-ALLOCATION-KEYWORD-POLICY
        )
...
class SwValues(ARObject):
    ...
    def __init__(self, values: list[SwValueElement] | None = None) -> None:
        self.values = []
        if values is not None:
...
class SwAxisCont(ARObject):
    ...
    def __init__(
        ...
        sw_values_phys: SwValues | None = None,
    ) -> None:
        ...
        self._assign_optional_strict(
            "unit_display_name", unit_display_name, SingleLanguageUnitNames
        )
...
class ValueSpecification(ARObject):
    ...
    @classmethod
    def _make_from_args(
        cls, label: str | None, value: Any, default_pattern: int | None = None
        ...
        if isinstance(value, (int, float)):
            ...
            if value[0].upper() in ("A", "ARRAY"):
                return ValueSpecification._make_array_value_spefication(
                    label, value[1:]
                )
            elif value[0].upper() in ("R", "RECORD"):
                return ValueSpecification._make_record_value_spefication(
                    label, value[1:]
                )
            else:
    ...
    @classmethod
    def _make_array_value_spefication(
        cls, label: str | None, values: list
    ) -> "ArrayValueSpecification":
        elements = []
        for value in values:
    ...
    @classmethod
    def _make_record_value_spefication(
        cls, label: str | None, values: list
    ) -> "RecordValueSpecification":
        fields = []
        for value in values:
...
class NumericalValueSpecification(ValueSpecification):
    ...
    def __init__(
        self, label: str | None = None, value: int | float | None = None
    ) -> None:
        super().__init__(label)
        self.value = value
            ...
            if isinstance(sw_axis_conts, SwAxisCont):
                ...
                for elem in sw_axis_conts:
                    if isinstance(elem, SwAxisCont):
                        ...
                        error_msg = (
                            "sw_axis_conts: Elements in list must of type SwAxisCont."
                        )
...
class ConstantSpecification(ARElement):
    ...
    def __init__(
        self, name: str, value: ValueSpeficationElement | None = None, **kwargs
    ) -> None:
        super().__init__(name, **kwargs)
    ...
    @classmethod
    def make_constant(
        cls, name: str, value: tuple[str, Any] | Any, **kwargs
...
class ConstantReference(ValueSpecification):
    ...
    def __init__(
        self, label: str | None = None, constant_ref: ConstantRef | None = None
    ) -> None:
...
class Package(CollectableElement):
    ...
    def make_packages(self, ref: str) -> "Package":
        ...
        if package is None:
            ...
            raise KeyError(
                f"Item with name '{parts[0]}' already exists but isn't a package"
            )
        if len(parts[2]) > 0:
