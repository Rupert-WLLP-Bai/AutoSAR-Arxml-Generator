...
xml_to_enum_map = {
    "ArrayImplPolicy": {
        "PAYLOAD-AS-ARRAY": VersionedEnumValue(
            ArrayImplPolicy.PAYLOAD_AS_ARRAY, {49, 50, 51}
        ),
        "PAYLOAD-AS-POINTER-TO-ARRAY": VersionedEnumValue(
            ArrayImplPolicy.PAYLOAD_AS_POINTER_TO_ARRAY, {49, 50, 51}
        ),
    },
    "ArraySizeHandling": {
    ...
    "IntervalType": {"CLOSED": IntervalType.CLOSED, "OPEN": IntervalType.OPEN},
    "KeepWithPrevious": {
...
enum_to_xml_map = {
    ...
    "SwCalibrationAccess": ["NOT-ACCESSIBLE", "READ-ONLY", "READ-WRITE"],  # 0  # 1  # 2
    "SwImplPolicy": [
        "CONST",  # 0
        "FIXED",  # 1
        "MEASUREMENT-POINT",  # 2
